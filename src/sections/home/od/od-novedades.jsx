...
const TICKER = [
  'Nueva camada — Cubaris Rubber Ducky',
  'Entrega en persona en CDMX',
  'Camada de julio disponible',
  'Apartas con el 50%',
];
    ...
    >
      <Box
        ...
        sx={{
          ...
          animation: `${reverse ? 'odMarqueeR' : 'odMarquee'} 52s linear infinite`,
        }}
      >
        {items.map((t, i) => (
      ...
      >
        ...
        <Box
          sx={{
            ...
            p: { xs: '28px 22px', md: '38px 46px 36px' },
          ...
          {sent ? (
            <Box
              sx={{
                ...
                fontFamily: 'var(--font-heading)',
                fontSize: 24,
                animation: 'odFade 0.4s ease both',
              }}
            >
            ...
            <>
              <Box
                sx={{ mt: 2.25, fontSize: 14, opacity: 0.78, maxWidth: '44ch', lineHeight: 1.6 }}
              >
                Un correo cada pocas semanas: especies disponibles, notas de cría y fechas de
                entrega. Nada más.
              </Box>
              <Box
                component="form"
